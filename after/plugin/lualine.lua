...
-- -- Define a custom theme for lualine with opacity
-- local custom_everforest = require'lualine.themes.everforest'
--
--
-- -- Customize the theme colors with 98% opacity for inactive sections
-- custom_everforest.inactive.a.bg = '#3B4252FA' -- 98% opacity
-- custom_everforest.inactive.b.bg = '#434C5EFA' -- 98% opacity
-- custom_everforest.inactive.c.bg = '#4C566AFA' -- 98% opacity
